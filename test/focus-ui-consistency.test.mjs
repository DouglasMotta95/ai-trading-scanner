...
test('0.11.9 loads standalone instrument focus and feed fallbacks for normal and recovery injection', () => {
  ...
  assert.ok(manifest.content_scripts.some(row => Array.isArray(row.js) && row.js[0] === 'src/content/standalone-instrument-probe.js' && row.world === 'MAIN'));
