...
test('current manifest is the v0.11.55 M5 clock state stability build', () => {
  assert.equal(manifest.version, '0.11.55');
  assert.equal(manifest.version_name, '0.11.55-time-sync-loop-fix');
