...
export function registerBuildContracts(label='build') {
  test(label + ': current extension package is the v0.11.58 professional-context build', () => {
    const m = manifest();
    assert.equal(m.manifest_version, 3);
    assert.equal(m.version, '0.11.58');
    assert.equal(m.version_name, '0.11.58-professional-context-filter');
