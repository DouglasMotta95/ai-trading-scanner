...
const EXTENSION_PACKAGE_FILE = path.resolve(__dirname, '../../downloads/ai-trading-scanner-latest.zip');
const SALES_PRICES = {
...
function serveExtensionPackage(res) {
  try {
    const data = fs.readFileSync(EXTENSION_PACKAGE_FILE);
    res.writeHead(200, {
      ...SECURITY_HEADERS,
